...
parser.add_argument('--exp-dir', default='experiment/MoPro', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Data loading code
    loader = dataloader.cifar10_dataloader(batch_size=args.batch_size,num_workers=args.workers,\
